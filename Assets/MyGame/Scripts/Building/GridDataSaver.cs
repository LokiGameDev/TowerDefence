...
public class GridDataSaver : MonoBehaviour
{
    ...
    public void Save(List<PlacementData> placedObjectsData)
    {
        ...
        System.IO.File.WriteAllText(PlayerPrefs.GetString("CurrentGamePath") + "/buildingData.json", json);
    ...
    {
        string path = PlayerPrefs.GetString("CurrentGamePath") + "/buildingData.json";
